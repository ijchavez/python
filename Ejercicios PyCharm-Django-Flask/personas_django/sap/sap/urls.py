...
from personas.views import detallePersona, nuevaPersona, editarPersona, eliminarPersona,\
    nuevoDomicilio, detalleDomicilio, editarDomicilio, eliminarDomicilio
...
urlpatterns = [
   ...
   # A partir de aca está el manejo de domicilios
   path('detalle_domicilios/<int:id>', detalleDomicilio),
